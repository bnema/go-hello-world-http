...
REPO="ghcr.io/bnema/go-hello-world-http"
TAG="latest"
DIST_DIR="./dist"
...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o $DIST_DIR/helloworld-linux-amd64 ./main.go
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -o $DIST_DIR/helloworld-linux-arm64 ./main.go
